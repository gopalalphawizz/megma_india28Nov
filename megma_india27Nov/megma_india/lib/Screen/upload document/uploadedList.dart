...
class UploadedListScr extends StatefulWidget {
  const UploadedListScr({Key? key}) : super(key: key);
  @override
  State createState() => _UploadedListScrState();
}

class _UploadedListScrState extends State {
...
List<UploadedListModel> uploadedList=[];
...
'mechanic_id':userid.toString(),

  };
  apiBaseHelper.postAPICall(getuploadListUrl, param).then((getData){
    bool error=getData['status'];
    String msg=getData['message'];
    if(error==true){

      uploadedList=GetUploadedModel.fromJson(getData).data??[];
